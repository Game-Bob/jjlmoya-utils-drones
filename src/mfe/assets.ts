...
const UTILITY_ASSET_ROOT = "/_utilities/drones";
...
export const getUtilityOgImage = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/drones/images/${englishSlug}.webp`);

export const getUtilityCssPath = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/drones/styles/${englishSlug}.css`);

export const CATEGORY_OG_IMAGE = getUtilityOgImage("drones");
